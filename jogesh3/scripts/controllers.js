...
angular.module('confusionApp')
            ...
            function($scope, menuFactory, corporateFactory ) 
        {
            ...
            this.getPromo = function(index)
            {
                return menuFactory.getPromotion(index);
            }

            this.getChef = function (index)
            {
                return corporateFactory.getLeader(index);
            }
            ...
            function($scope, corporateFactory) 
        {
            ...
            self.leaders = corporateFactory.getLeaders();
